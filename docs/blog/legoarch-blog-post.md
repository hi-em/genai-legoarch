...
![The lEgoarCh pipeline on one line.](assets/pipeline.svg)
...
![The five-move experience: visualize, materialize, legolize, pack, keep.](assets/slide-experience.png)
...
![The app developing the render, with a note on what a LoRA is.](assets/02-waiting-prompt.png)
...
![LoRA strength test at 0, 0.5 and 1.0; 1.0 wins.](assets/slide-lora.png)
...
![Three ComfyUI graphs sharing one FLUX plus LoRA core.](assets/slide-workflows.png)
...
![How split-and-merge covers a layer with real bricks.](assets/split-and-merge.svg)
...
![The parts catalog: 44 real parts, 48 colours, 1,598 validated combinations.](assets/slide-catalog.png)
...
![Why nearest-colour is perceptual math, not RGB.](assets/perceptual-colour.svg)
...
![The mesh on the left, the solved brick model on the right.](assets/07-mesh-vs-lego.png)
...
![The denoise pass: the same Sagrada with 46% fewer bricks.](assets/slide-fortysix.png)
...
![One sentence in, many outputs out: render, mesh, build, boxed set, booklet, price.](assets/slide-outputs.png)
...
![The collection shelf in 3D.](assets/10-shelf-3d.png)
*The shelf, in 3D. Saved sets become a collection you can rotate and revisit.*

![The collection as a list with names and prices.](assets/11-shelf-list.png)
...
![The voxelized Guggenheim Bilbao: structurally sound, but a blob.](assets/slide-bilbao.png)
